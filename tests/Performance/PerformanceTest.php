...
class PerformanceTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testMatcher()
    {
        ...
        $matcher->hostMatches('/lastcallmedia.com/');
        $matcher->pathIs('foo');
        $matcher->pathMatches('/foo/');
        $matcher->queryIs('bar');
        $matcher->queryMatches('/bar/');
        $matcher->fragmentIs('baz');
        $matcher->fragmentMatches('/baz/');

        $uri = new Uri('https://lastcallmedia.com/foo?bar#baz');
